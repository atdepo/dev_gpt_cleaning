...
<<<<<<<< Updated upstream:dev_gpt_files/zero_few_shot_classification.py
        with open('../datasets/output_filtered.json', 'r') as f:
========
        with open('datasets/output_filtered.json', 'r') as f:
>>>>>>>> Stashed changes:zero_few_shot_classification.py
            data = json.load(f)
            i = 1
...
========
        # Open and read input dataset file
        with open(f'zero-few-iterations/dataset_prompt_step_3_v{idx-1}.json', 'r') as f:
>>>>>>>> Stashed changes:zero_few_shot_classification.py
            data = json.load(f)
            i = 1
